...
function ThemeBuilderPageContent() {
  ...
  const updateThemeTabIconMutation = useUpdateThemeTabIcon()
  ...
  const handleTabIconUpload = (tabId: string, file: File) => {
    return updateThemeTabIconMutation.mutateAsync({ id: tabId, file })
  }
  ...
  return (
    ...
    >
      ...
      <TabManagerPanel
        ...
        onTabIconUpload={handleTabIconUpload}
      />
