...
import { notificationCampaignService, type NotificationTemplate } from "@/services/notificationCampaignService"
 ...
 * (`POST /admin/abandoned-carts/:id/notify`) once per selected episode.
 * Bulk sends are looped client-side rather than through the per-mutation
 * toast hook, since firing N individual success toasts for a 50-cart
 * selection would be worse UX than one summary toast.
 */
