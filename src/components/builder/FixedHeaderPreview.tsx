          ...
          return (
            <div
              ...
              onClick={(e) => {
                ...
                // Every pixel of this row is covered by a tab item, so a
                // plain click here never reaches the row's own onClick
                // below (stopPropagation always fires first) — the "Tab
                // text color" editor was effectively unreachable. Open it
                // directly from here instead of relying on bubbling, in
                // addition to switching the previewed tab.
                e.stopPropagation()
