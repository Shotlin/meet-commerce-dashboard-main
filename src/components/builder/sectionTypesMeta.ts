...
export const sectionTypesMeta: SectionTypeMeta[] = [
...

  {
    ...
    maxPerTab: 2,
    defaultConfig: { layout_mode: "horizontal_scroll", columns: 4, icon_size: 64, gap: 12, row_gap: 14, show_labels: true, section_header: { style: "text", visible: true, image_aspect_ratio: 3.6, image_width: 1080, image_height: 300, border_radius: 14, horizontal_margin: 16, bottom_spacing: 12 } },
  ...
  },
  {
    ...
    maxPerTab: 2,
    defaultConfig: { layout_mode: "horizontal_scroll", columns: 4, icon_size: 48, gap: 8, row_gap: 14, show_labels: true, section_header: { style: "text", visible: true, image_aspect_ratio: 3.6, image_width: 1080, image_height: 300, border_radius: 14, horizontal_margin: 16, bottom_spacing: 12 } },
    accentClassName: "bg-cyan-100 text-cyan-700 border-cyan-200",
    group: "categories",
    tags: ["Fresh"],
    dataSources: ["category"],
  ...
  },
  {
    ...
    maxPerTab: 2,
    defaultConfig: { layout_mode: "horizontal_scroll", columns: 4, icon_size: 64, gap: 12, row_gap: 14, show_labels: false, section_header: { style: "text", visible: true, image_aspect_ratio: 3.6, image_width: 1080, image_height: 300, border_radius: 14, horizontal_margin: 16, bottom_spacing: 12 } },
    accentClassName: "bg-cyan-100 text-cyan-700 border-cyan-200",
    group: "categories",
    tags: ["Fresh"],
    dataSources: ["category"],
  ...
  // are both already read by the Flutter renderer.
  {
    ...
    label: "Premium Fresh — Product Grid",
    icon: Grid3x3,
    description: "Multi-column product block for category-led merchandising.",
    maxPerTab: 20,
    defaultConfig: { columns: 2, card_shape: "rounded", product_card_style: "PREMIUM_FRESH", section_header: { style: "text", visible: true, image_aspect_ratio: 3.6, image_width: 1080, image_height: 300, border_radius: 14, horizontal_margin: 16, bottom_spacing: 12 } },
  ...
  },
  {
    ...
    type: "category_product_grid",
    label: "Premium Fresh — Large Photo Cards",
    icon: Grid3x3,
    description: "Full-width product photography with swipeable images, description and pricing.",
    maxPerTab: 20,
    defaultConfig: { columns: 1, card_shape: "rounded", product_card_style: "PREMIUM_FRESH", title: "Fresh cuts, made for your kitchen", subtitle: "Your next great meal starts here." },
    accentClassName: "bg-sky-100 text-sky-700 border-sky-200",
    group: "products",
    tags: ["Bestseller", "Fresh"],
    dataSources: ["category", "manual_products", "tags"],
    useCase: "Large catalog cards matching the photo-led reference.",
  },
  {
...

  {
    ...
    label: "Premium Fresh — Product Slider",
    icon: Columns,
    description: "Scrollable strip of product cards for focused assortments.",
    maxPerTab: 20,
    defaultConfig: { product_card_style: "PREMIUM_FRESH", auto_scroll: false, title: "Our current hits", subtitle: "Here’s what everyone’s eating!", section_header: { style: "text", visible: true, image_aspect_ratio: 3.6, image_width: 1080, image_height: 300, border_radius: 14, horizontal_margin: 16, bottom_spacing: 12 } },
  ...
  {
    id: "promo_carousel__premium_wide",
    type: "promo_carousel",
    label: "Premium Fresh — Wide Image Slides",
    icon: Image,
    description: "Clean rounded promotional strips. Upload each slide separately.",
    maxPerTab: 3,
    defaultConfig: { banner_source: "custom", aspect_ratio: "5:1", border_radius: 14, auto_scroll: true, images: [] },
    accentClassName: "bg-rose-100 text-rose-700 border-rose-200",
    group: "hero",
    tags: ["Deals"],
    dataSources: ["static"],
    useCase: "Place image-only campaigns between product sections.",
  },
  {
