...
export const sectionTypesMeta: SectionTypeMeta[] = [
  ...
  // are both already read by the Flutter renderer.
  {
    ...
    maxPerTab: 20,
    defaultConfig: { columns: 2, card_shape: "rounded", product_card_style: "PREMIUM_FRESH" },
...

  {
    ...
    maxPerTab: 20,
    defaultConfig: { product_card_style: "PREMIUM_FRESH", auto_scroll: false, title: "Our current hits", subtitle: "Here’s what everyone’s eating!" },
