  ...
  return (
    <div className={cn("space-y-2", className)}>
          ...
          <PopoverTrigger asChild>
            ...
            >
              <span className="truncate">
                {value && currentFamily ? currentFamily.name : "Select or create a family…"}
              </span>
              ...
              {isLoading ? (
                ...
                items.map((fam) => (
                  ...
                  >
                    ...
                    {value === fam.id && <Check className="h-4 w-4 text-primary" />}
                  </button>
                ))
              )}
            </div>
      ...
      {value && currentFamily ? (
        ...
        <p className="text-xs text-muted-foreground">
          Leave empty for single-option products. Pick or create a family to group multiple
          options (e.g. 500g, 1kg).
        </p>
      )}
    </div>
  )
